...
write.csv(uptake, "Covid-winter-booster-/data/uptake_by_area_series.csv", row.names = FALSE)
write.csv(latest_coverage, "Covid-winter-booster-/data/uptake_by_area_latest.csv", row.names = FALSE)
